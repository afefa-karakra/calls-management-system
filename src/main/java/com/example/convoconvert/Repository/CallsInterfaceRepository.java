...
//    @Query("SELECT cu.id AS customer_idfk, e.name AS name, c.audio_text, c.audio, c.started " +
//            "FROM Calls c" +
//
//            "JOIN Customer cu ON c.customer_idfk = cu.id" +
//            "JOIN Employee e ON c.employee_idfk = e.id")
